...
struct llama_model {
    ...
    ggml_cgraph * build_graph(const llm_graph_params & params, struct llama_pipeline_setup * pipeline_setup = nullptr, struct llama_pipeline_sched ** p_pipeline = nullptr, struct llama_moe_weight_cache * moe_cache = nullptr) const;
